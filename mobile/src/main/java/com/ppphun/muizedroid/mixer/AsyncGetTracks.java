...
import static com.pppphun.muizedroid.MixerService.PLAY_MODE_ALBUM;
import static com.pppphun.muizedroid.MixerService.PLAY_MODE_BROWSE;
import static com.pppphun.muizedroid.MixerService.PLAY_MODE_PLAYLIST;
import static com.pppphun.muizedroid.MixerService.PLAY_MODE_RANDOM;
...
public class AsyncGetTracks extends AsyncTask<Void, Void, Vector<Track>>
{
    ...
    protected void onPostExecute(Vector<Track> tracks)
    {
            ...
            results.add(
                    new MediaBrowserCompat.MediaItem(
                            new MediaDescriptionCompat.Builder()
                                    .setMediaId(Mixer.getAppContext().getString(R.string.item_root_id))
                                    .setTitle(Mixer.getAppContext().getString(R.string.item_root_desc))
                                    .build(),
            ...
            results.add(
                    new MediaBrowserCompat.MediaItem(
                            new MediaDescriptionCompat.Builder()
                                    ...
                                    .setTitle(Mixer.getAppContext().getString(R.string.up_one_level_songs))
                                    .build(),
                            MediaBrowserCompat.MediaItem.FLAG_BROWSABLE
                    )
            );
            ...
            if (defective > 0) {
                ...
                results.add(
                        new MediaBrowserCompat.MediaItem(
                                new MediaDescriptionCompat.Builder()
                                        .setMediaId(Mixer.getAppContext().getString(R.string.item_root_id))
                                        .setTitle(String.format(Mixer.getAppContext().getString(R.string.error_defective_tracks), defective))
                                        .build(),
                                MediaBrowserCompat.MediaItem.FLAG_BROWSABLE
                        )
                );
        ...
        intent.putExtra(Mixer.getAppContext().getString(R.string.async_finished_broadcast_type), Mixer.getAppContext().getResources().getInteger(R.integer.async_get_tracks));
